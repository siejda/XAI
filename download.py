...
USERNAME = 'ks108486@student.sgh.waw.pl'
PASSWORD = 'D1<?|;y;'
START_YEAR = 2002
END_YEAR = 2022
...
def get_data_from_url(year):
    download = urllib.request.urlretrieve('https://freddiemac.embs.com/FLoan/Data/sample_' + str(year) + '.zip',
...
def start_execution():
    with requests.Session() as sess:
          ...
          log( " SUCCESS   : Login into succesful ")
